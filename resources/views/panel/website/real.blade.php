            ...
            <form action="{{ route('panel.website.update', ['seccion' => request('seccion')]) }}"
                ...
                <div class="w-full">
                    <div class=" mb-6">
                        ...
                        <div class="">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="real_video">URL
                                video</label>
                            <input id="real_video" name="real_video" value="{{ $data->real_video }}" autocomplete="off"
