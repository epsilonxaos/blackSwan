...
@section('content')
    <div class="relative overflow-x-auto pt-6 px-1">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            @if (\App\Helpers\Helpers::validPermission(request('seccion'), 'create'))
                <form action="{{ route('panel.proyectos.store', ['seccion' => request('seccion')]) }}" method="POST"
                            ...
                            <div class="grid grid-cols-1 gap-5 mb-6">
                                <div class="col-span-1">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="cover" class="dropify" required data-height="300"
                                    ...
                                    <div class="mb-3">
                                        <label for="website"
                                            ...
                                            Website</label>
                                        <input id="website" name="website" value="{{ old('website') }}" autocomplete="off"
                                    ...
                                    <div id="myTabContent">
                                        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="es"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input id="subtitle" name="subtitle[es]" value="{{ old('subtitle') }}"
                                        ...
                                        <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="en"
                                            ...
                                            <div class="mb-3">
                                                <label for="title"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><span
                                                        class="text-red-800">*</span> Titulo</label>
                                                <input id="title" name="title[en]" value="{{ old('title') }}"
                                                    required autocomplete="off"
                                                    class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            </div>
                                            <div class="mb-3">
                                                <label for="subtitle"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"><span
                                                        class="text-red-800">*</span> Subtitulo</label>
                                                <input id="subtitle" name="subtitle[en]" value="{{ old('subtitle') }}"
                                                    required autocomplete="off"
                                                    class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            </div>
                                            <div class="mb-3">
