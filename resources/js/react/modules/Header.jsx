            ...
            <HeaderContext.Provider value={{ active, setActive }}>
                <header className="bg-black text-white w-full fixed z-50 top-0 left-0">
                    <MainContainer className="px-4 flex items-center justify-between min-h-[64px]">
                        ...
                        <button
                            ...
                            className={`transition-colors w-[60px] border border-white rounded-lg py-[2px] px-[8px] ${
                ...
                {active && (
                    <div
                        ...
                        className="backdrop-blur-sm bg-black bg-opacity-50 z-30 fixed top-0 left-0 h-screen w-screen"
                    ></div>
                )}
