                    ...
                    <div class=" mb-6">
                        ...
                        <div id="tab-content-secc2">
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="es-secc2" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="capital_s2_info">Descripción 1</label>
                                    <textarea name="capital_s2_info[es]" class="trumbowyg-panel" cols="30" rows="10">{{ $data->{'capital_s2_info:es'} }}</textarea>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-2">
                                    <div class="col-span-1">
                                        ...
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="capital_s2_n1info">Descripción 1</label>
                                            <input id="capital_s2_n1info" name="capital_s2_n1info[es]"
                                                value="{{ $data->translate('es')->capital_s2_n1info }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        ...
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="capital_s2_n2info">Descripción 2</label>
                                            <input id="capital_s2_n2info" name="capital_s2_n2info[es]"
                                                value="{{ $data->translate('es')->capital_s2_n2info }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        ...
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="capital_s2_n3info">Descripción 3</label>
                                            <input id="capital_s2_n3info" name="capital_s2_n3info[es]"
                                                value="{{ $data->translate('es')->capital_s2_n3info }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="capital_s2_info2">Descripción 2</label>
                                    <textarea name="capital_s2_info2[es]" class="trumbowyg-panel" cols="30" rows="10">{{ $data->{'capital_s2_info2:es'} }}</textarea>
                                </div>
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="en-secc2" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="capital_s2_info">Descripción 1</label>
                                    <textarea name="capital_s2_info[en]" class="trumbowyg-panel" cols="30" rows="10">{{ $data->{'capital_s2_info:en'} }}</textarea>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-2">
                                    <div class="col-span-1">
                                        ...
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="capital_s2_n1info">Descripción 1</label>
                                            <input id="capital_s2_n1info" name="capital_s2_n1info[en]"
                                                value="{{ $data->translate('en')->capital_s2_n1info }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        ...
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="capital_s2_n2info">Descripción 2</label>
                                            <input id="capital_s2_n2info" name="capital_s2_n2info[en]"
                                                value="{{ $data->translate('en')->capital_s2_n2info }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        ...
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="capital_s2_n3info">Descripción 3</label>
                                            <input id="capital_s2_n3info" name="capital_s2_n3info[en]"
                                                value="{{ $data->translate('en')->capital_s2_n3info }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="capital_s2_info2">Descripción 2</label>
                                    <textarea name="capital_s2_info2[en]" class="trumbowyg-panel" cols="30" rows="10">{{ $data->{'capital_s2_info2:en'} }}</textarea>
                                </div>
                            </div>
                        </div>
