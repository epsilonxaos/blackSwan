                    ...
                    <div class=" mb-6">
                        ...
                        <div id="tab-content-secc1">
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="es-secc1" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s1_title">Título</label>
                                    <textarea name="hospi_s1_title[es]" class="shorttext" cols="30" rows="3">{{ $data->{'hospi_s1_title:es'} }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s1_subtitle">Subtítulo</label>
                                    <textarea name="hospi_s1_subtitle[es]" class="shorttext" cols="30" rows="3">{{ $data->{'hospi_s1_subtitle:es'} }}</textarea>
                                </div>
                            </div>
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="en-secc1" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s1_title">Título banner 1</label>
                                    <textarea name="hospi_s1_title[en]" class="shorttext" cols="30" rows="10">{{ $data->{'hospi_s1_title:en'} }}</textarea>
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s1_subtitle">Título banner 2</label>
                                    <textarea name="hospi_s1_subtitle[en]" class="shorttext" cols="30" rows="10">{{ $data->{'hospi_s1_subtitle:en'} }}</textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class=" mb-6">
                        ...
                        <div id="tab-content-secc2">
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="es-secc2" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s2_title1">Título 1</label>
                                    <input id="hospi_s2_title1" name="hospi_s2_title1[es]"
                                        value="{{ $data->translate('es')->hospi_s2_title1 }}" autocomplete="off"
                                        class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s2_title2">Título 2</label>
                                ...
                                {{-- <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-2">
                                    <div class="col-span-1">
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n1title">Título 1</label>
                                            <input id="hospi_s2_n1title" name="hospi_s2_n1title[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n1title }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n1subtitle">Subtítulo 1</label>
                                            <input id="hospi_s2_n1subtitle" name="hospi_s2_n1subtitle[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n1subtitle }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n1info">Descripción 1</label>
                                            <input id="hospi_s2_n1info" name="hospi_s2_n1info[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n1info }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n2title">Título 2</label>
                                            <input id="hospi_s2_n2title" name="hospi_s2_n2title[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n2title }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n2subtitle">Subtítulo 2</label>
                                            <input id="hospi_s2_n2subtitle" name="hospi_s2_n2subtitle[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n2subtitle }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n2info">Descripción 2</label>
                                            <input id="hospi_s2_n2info" name="hospi_s2_n2info[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n2info }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n3title">Título 3</label>
                                            <input id="hospi_s2_n3title" name="hospi_s2_n3title[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n3title }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n3subtitle">Subtítulo 3</label>
                                            <input id="hospi_s2_n3subtitle" name="hospi_s2_n3subtitle[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n3subtitle }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n3info">Descripción 3</label>
                                            <input id="hospi_s2_n3info" name="hospi_s2_n3info[es]"
                                                value="{{ $data->translate('es')->hospi_s2_n3info }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                </div> --}}
                                ...
                                {{-- <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s2_info2">Descripción 2</label>
                                    <textarea name="hospi_s2_info2[es]" class="trumbowyg-panel" cols="30" rows="10">{{ $data->{'hospi_s2_info2:es'} }}</textarea>
                                </div> --}}
                            ...
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="en-secc2" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="hospi_s2_title1" name="hospi_s2_title1[en]"
                                        value="{{ $data->translate('en')->hospi_s2_title1 }}" autocomplete="off"
                                        class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                </div>
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                ...
                                {{-- <div class="grid grid-cols-1 md:grid-cols-3 md:gap-x-2">
                                    <div class="col-span-1">
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n1title">Título 1</label>
                                            <input id="hospi_s2_n1title" name="hospi_s2_n1title[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n1title }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n1subtitle">Subtítulo 1</label>
                                            <input id="hospi_s2_n1subtitle" name="hospi_s2_n1subtitle[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n1subtitle }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n1info">Descripción 1</label>
                                            <input id="hospi_s2_n1info" name="hospi_s2_n1info[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n1info }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n2title">Título 2</label>
                                            <input id="hospi_s2_n2title" name="hospi_s2_n2title[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n2title }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n2subtitle">Subtítulo 2</label>
                                            <input id="hospi_s2_n2subtitle" name="hospi_s2_n2subtitle[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n2subtitle }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n2info">Descripción 2</label>
                                            <input id="hospi_s2_n2info" name="hospi_s2_n2info[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n2info }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                    <div class="col-span-1">
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n3title">Título 3</label>
                                            <input id="hospi_s2_n3title" name="hospi_s2_n3title[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n3title }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n3subtitle">Subtítulo 3</label>
                                            <input id="hospi_s2_n3subtitle" name="hospi_s2_n3subtitle[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n3subtitle }}"
                                                autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                        <div class="mb-3">
                                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                                for="hospi_s2_n3info">Descripción 3</label>
                                            <input id="hospi_s2_n3info" name="hospi_s2_n3info[en]"
                                                value="{{ $data->translate('en')->hospi_s2_n3info }}" autocomplete="off"
                                                class="mb-4 disabled:opacity-50 disabled:pointer-events-none bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        </div>
                                    </div>
                                </div> --}}
                                ...
                                {{-- <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s2_info2">Descripción 2</label>
                                    <textarea name="hospi_s2_info2[en]" class="trumbowyg-panel" cols="30" rows="10">{{ $data->{'hospi_s2_info2:en'} }}</textarea>
                                </div> --}}
                            </div>
                        </div>
                    ...
                    <div class=" mb-6">
                        ...
                        <div id="tab-content-secc3">
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="es-secc3" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s3_title">Título</label>
                                    <textarea name="hospi_s3_title[es]" class="shorttext" cols="30" rows="3">{{ $data->{'hospi_s3_title:es'} }}</textarea>
                                </div>
                            </div>
                            <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="en-secc3" role="tabpanel"
                                ...
                                <div class="mb-3">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                        for="hospi_s3_title">Título</label>
                                    <textarea name="hospi_s3_title[en]" class="shorttext" cols="30" rows="10">{{ $data->{'hospi_s3_title:en'} }}</textarea>
                                </div>
                            </div>
                        </div>
